...
if __name__ == '__main__':
    ...
    for i in range(max_iters):
        ...
        dt_policy = xgb.XGBClassifier( learning_rate =0.1, n_estimators=250 ,max_depth=5, min_child_weight=1, gamma=0,subsample=0.8,colsample_bytree=0.8,nthread=4,scale_pos_weight=1,seed=27)
        dt_policy.fit(serials_train, actions_train)
